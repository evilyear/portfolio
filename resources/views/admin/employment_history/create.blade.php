                ...
                @foreach( config('translatable.locales') as  $localItem)
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error($localItem.'.title') is-invalid @enderror" 
                                id="text-{{ $localItem }}" 
                                name="{{ $localItem }}[text]" 
                                rows="3">{{ old($localItem.'.text') }}
                            </textarea>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" 
                        class="form-control @error('timeFrtimeTillom') is-invalid @enderror"
                        id="timeTill" 
                        name="timeTill" 
                        placeholder="2015"
                        value="{{ old('timeTill') }}">
